...
const SingleUserDetails = () => {
  ...
  return (
   ...
   <h2 className="font-semibold text-2xl mb-4">{user.name}</h2>
    <p className="text-lg mb-2">Email: <span className="font-medium">{user.email}</span></p>
    <p className="text-lg mb-2">Phone: <span className="font-medium">{user.phone}</span></p>
    <p className="text-lg mb-2">Company: <span className="font-medium">{user.company.name}</span></p>
   <Link to='/'>
